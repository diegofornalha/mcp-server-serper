...
/**
 * Implementação do servidor MCP com suporte a STDIO que fornece recursos de busca na web via API Serper.
 */
...
const server = new Server(
  {
    name: "Servidor MCP Serper (STDIO)",
    version: "0.2.0",
  },
  {
    capabilities: {
...
// Função para iniciar o servidor usando o transporte STDIO
async function main() {
  try {
    ...
    // O servidor agora está pronto para receber mensagens através do STDIO
    console.error(`Servidor MCP com STDIO iniciado`);
  } catch (error) {
